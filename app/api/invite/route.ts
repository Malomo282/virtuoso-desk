...
const{error:emailError}=await resend.emails.send({from:'Virtuoso Collective <bookings@virtuosoentertainment.co.uk>',to:email,subject:'You have been invited to join Virtuoso Collective',html:`<div style="font-family:Arial,sans-serif;max-width:520px;margin:0 auto"><div style="background:#151A22;padding:32px;text-align:center"><div style="font-size:36px;font-weight:bold;color:#C8A24A">VC</div><div style="color:#fff;font-size:13px;letter-spacing:0.2em;text-transform:uppercase;margin-top:8px">Virtuoso Collective Ltd</div></div><div style="padding:32px;background:#0E1117"><h2 style="color:#fff">You have been invited</h2><p style="color:#8A96A8">You have been invited to join the Virtuoso Collective artist roster.</p><p style="color:#8A96A8">Click below to create your account. This link expires in 7 days.</p><div style="text-align:center;margin:32px 0"><a href="${registerUrl}" style="background:#C8A24A;color:#0E1117;font-weight:bold;padding:14px 32px;border-radius:8px;text-decoration:none;font-size:14px;text-transform:uppercase">Create my account</a></div><p style="color:#4E5A6A;font-size:12px">If you were not expecting this, ignore this email.</p></div><div style="background:#151A22;padding:16px;text-align:center"><p style="color:#4E5A6A;font-size:11px;margin:0">Virtuoso Collective Ltd - bookings@virtuosoentertainment.co.uk</p></div></div>`})
