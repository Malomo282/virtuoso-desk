...
for (const name of names) {
  ...
  const checks = [
    ...
    ['sidebar-foreground on sidebar', c('sidebar-foreground'), c('sidebar'), 4.5],
    ['muted-foreground on background', c('muted-foreground'), c('background'), 4.5],
    ['muted-foreground on card', c('muted-foreground'), c('card'), 4.5],
    ['sidebar-muted on sidebar', c('sidebar-muted'), c('sidebar'), 4.5],
    ['muted-foreground/80 on card', over(c('muted-foreground'), c('card'), 0.8), c('card'), 4.5],
    ['sidebar-muted/70 on sidebar (dividers)', over(c('sidebar-muted'), c('sidebar'), 0.7), c('sidebar'), 4.5],
    ...
    ['sidebar-primary on sidebar', c('sidebar-primary'), c('sidebar'), 4.5],
    ['sidebar-primary on sidebar-accent (active)', c('sidebar-primary'), c('sidebar-accent'), 4.5],
    ['sidebar on sidebar-primary (badge)', c('sidebar'), c('sidebar-primary'), 4.5],
    ['destructive on sidebar (sign out)', c('sidebar-destructive'), c('sidebar'), 4.5],
